...
class TestAddRecipeView(TestCase):
    ...
    def setUp(self):
        ...
        (username='chef_david', password='password123')
...
class TestEditDeleteViews(TestCase):
    ...
    def setUp(self):
        ...
        (username='bad_actor', password='password123')
    ...
    def test_author_can_access_edit_page(self):
        ...
        (reverse('edit_recipe', args=[self.recipe.slug]))
        self.assertEqual(response.status_code, 200)
    ...
    def test_successful_recipe_update(self):
        ...
        (reverse('edit_recipe',  args=[self.recipe.slug]), updated_data)
        self.assertEqual(response.status_code, 302)
